...
\definecolor{QuotelineColor}{HTML}{B58900}
\definecolor{QuoteColor}{HTML}{93A1A1}
\definecolor{LinkColor}{HTML}{268BD2}
\definecolor{CodeColor}{HTML}{CB4B16}
\definecolor{ShadeColor}{HTML}{EEE8D5}
...
\hypersetup{
	...
	pdfsubject={$subject$},
	$endif$
	pdfcreator={XeLaTeX via Pandoc solarized theme},
}
	%-------underline all links
\makeatletter
\Hy@AtBeginDocument{%
