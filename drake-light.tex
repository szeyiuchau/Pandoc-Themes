...
\definecolor{CodeBlockBgColor}{HTML}{F6F8FA}
\definecolor{CodeBlockColor}{HTML}{24292E}
...
\hypersetup{
	...
	pdfsubject={$subject$},
	$endif$
	pdfcreator={XeLaTeX via Pandoc drake-light theme},
}
	%-------underline all links
\makeatletter
\Hy@AtBeginDocument{%
...
\newcommand{\AttributeTok}[1]{\textcolor[HTML]{24292E}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
...
\newcommand{\DecValTok}[1]{\textcolor[HTML]{4A86E8}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\DocumentationTok}[1]{#1}
\newcommand{\ErrorTok}[1]{\textcolor{red}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\ExtensionTok}[1]{#1}
\newcommand{\FloatTok}[1]{\textcolor[HTML]{4A86E8}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
