...
\renewcommand{\theFancyVerbLine}{\textcolor[HTML]{545454}{\small\arabic{FancyVerbLine}}}
...
\definecolor{BackgroundColor}{HTML}{212121}
\definecolor{TextColor}{HTML}{B3BEC4}
\definecolor{TitleColor}{HTML}{BBC6D2}
\definecolor{DrakeAccentColor}{HTML}{FF9800}
\definecolor{DrakeHighlightColor}{HTML}{FF9800}
\definecolor{BlockquoteBgColor}{RGB}{255,185,82}
\definecolor{CodeBlockBgColor}{HTML}{1B1B1B}
\definecolor{TableBorderColor}{HTML}{323232}
\definecolor{TableEvenColor}{HTML}{292929}
...
\hypersetup{
	...
	pdfsubject={$subject$},
	$endif$
	pdfcreator={XeLaTeX via Pandoc drake-black theme},
}
	%-------underline all links
\makeatletter
\Hy@AtBeginDocument{%
...
\newcommand{\CommentTok}[1]{\textcolor[HTML]{545454}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
