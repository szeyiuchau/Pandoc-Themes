...
\definecolor{TitleColor}{HTML}{135CE0}
\definecolor{GridColor}{RGB}{60,10,30}
\definecolor{DrakeAccentColor}{HTML}{E95F59}
\definecolor{DrakeHighlightColor}{HTML}{D63200}
\definecolor{InlineCodeBgColor}{HTML}{FFF5F5}
\definecolor{BlockquoteColor}{HTML}{595959}
\definecolor{BlockquoteBgColor}{HTML}{FFF9F9}
\definecolor{BlockquoteBorderColor}{HTML}{B2AEC5}
\definecolor{CodeBlockBgColor}{HTML}{2B2B2B}
\definecolor{CodeBlockColor}{HTML}{A9B7C6}
\definecolor{TableBorderColor}{HTML}{DFE2E5}
\definecolor{TableEvenColor}{HTML}{F6F8FA}
\definecolor{LinkColor}{HTML}{036ACA}
...
\hypersetup{
	...
	pdfsubject={$subject$},
	$endif$
	pdfcreator={XeLaTeX via Pandoc drake theme},
}
	%-------underline all links
\makeatletter
\Hy@AtBeginDocument{%
...
%			\draw[step=20\px,line width=0.6\px](current page.north west) grid (current page.south east);
%		\end{tikzpicture}
%	}
%}
%fonts
