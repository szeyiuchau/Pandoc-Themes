...
\definecolor{BackgroundColor}{HTML}{2B2B2B}
\definecolor{TextColor}{HTML}{ACB7C4}
\definecolor{TitleColor}{HTML}{BBC9D7}
\definecolor{DrakeAccentColor}{HTML}{3473B0}
\definecolor{DrakeHighlightColor}{HTML}{58A1D6}
\definecolor{BlockquoteBgColor}{RGB}{52,115,176}
\definecolor{CodeBlockBgColor}{HTML}{222222}
\definecolor{CodeBlockColor}{HTML}{A9B7C6}
\definecolor{TableBorderColor}{HTML}{383838}
\definecolor{TableEvenColor}{HTML}{222222}
...
\hypersetup{
	...
	pdfsubject={$subject$},
	$endif$
	pdfcreator={XeLaTeX via Pandoc drake-dark theme},
}
	%-------underline all links
\makeatletter
\Hy@AtBeginDocument{%
...
\renewenvironment{quote}{
	\begin{tcolorbox}[
		...
		outer arc=2\px,
		arc=2\px,
		colback=BlockquoteBgColor!10!BackgroundColor,
		coltext=TextColor,
		boxsep=0em,
		top=10\px,
		bottom=10\px,
...
\newcommand{\BuiltInTok}[1]{\textcolor[HTML]{24292E}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
...
\newcommand{\OperatorTok}[1]{\textcolor[HTML]{A9B7C6}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\OtherTok}[1]{#1}
\newcommand{\PreprocessorTok}[1]{#1}
\newcommand{\RegionMarkerTok}[1]{#1}
\newcommand{\SpecialCharTok}[1]{#1}
\newcommand{\SpecialStringTok}[1]{\textcolor[HTML]{6A8759}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\StringTok}[1]{\textcolor[HTML]{6A8759}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\VariableTok}[1]{\textcolor[HTML]{A9B7C6}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
