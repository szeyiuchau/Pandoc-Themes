...
\renewcommand{\theFancyVerbLine}{\textcolor[HTML]{585B5D}{\small\arabic{FancyVerbLine}}}
...
\definecolor{TextColor}{HTML}{202124}
\definecolor{TitleColor}{HTML}{202124}
\definecolor{LinkColor}{HTML}{1769E0}
\definecolor{DrakeAccentColor}{HTML}{5784EC}
\definecolor{DrakeHighlightColor}{HTML}{3A474E}
\definecolor{InlineCodeBgColor}{HTML}{F8F9FA}
\definecolor{InlineCodeBorderColor}{HTML}{E8EAED}
\definecolor{BlockquoteBgColor}{HTML}{E5F4FD}
\definecolor{BlockquoteColor}{HTML}{275796}
\definecolor{CodeBlockBgColor}{HTML}{F8F9FA}
\definecolor{CodeBlockColor}{HTML}{3A474E}
\definecolor{TableBorderColor}{HTML}{DADCE0}
\definecolor{TableHeaderColor}{HTML}{F8F8F8}
...
\hypersetup{
	...
	pdfsubject={$subject$},
	$endif$
	pdfcreator={XeLaTeX via Pandoc drake-google theme},
}
	%-------underline all links
\makeatletter
\Hy@AtBeginDocument{%
...
\newcommand{\AttributeTok}[1]{\textcolor[HTML]{787878}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\BaseNTok}[1]{#1}
\newcommand{\BuiltInTok}[1]{\textcolor[HTML]{3A474E}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\CharTok}[1]{#1}
\newcommand{\CommentTok}[1]{\textcolor[HTML]{B80672}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\CommentVarTok}[1]{#1}
\newcommand{\ConstantTok}[1]{#1}
\newcommand{\ControlFlowTok}[1]{#1}
\newcommand{\DataTypeTok}[1]{\textcolor[HTML]{9334E6}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\DecValTok}[1]{\textcolor[HTML]{C5221F}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\DocumentationTok}[1]{#1}
\newcommand{\ErrorTok}[1]{\textcolor[HTML]{BC3F3C}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\ExtensionTok}[1]{#1}
\newcommand{\FloatTok}[1]{\textcolor[HTML]{C5221F}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\FunctionTok}[1]{#1}
\newcommand{\ImportTok}[1]{#1}
\newcommand{\InformationTok}[1]{#1}
\newcommand{\KeywordTok}[1]{\textcolor[HTML]{1967D2}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
...
\newcommand{\SpecialStringTok}[1]{\textcolor[HTML]{008000}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
\newcommand{\StringTok}[1]{\textcolor[HTML]{008000}{\FancyVerbBreakStart#1\FancyVerbBreakStop}}
...
\def\VERB|#1|{
	\tcbox[
		...
		right=0.4em,
		left=0.4em,
	]{\hspace{4\px}\Verb[breaklines,breakanywhere,commandchars=\\\{\}]|#1|\hspace{4\px}}
}
...
\renewenvironment{longtable}[3]{
	...
	\edef\pream{{\pream|}}
	\newcommand{\toprule}[2]{\rowcolor{TableHeaderColor}}
