...
\definecolor{BackgroundColor}{HTML}{282838}
\definecolor{TextColor}{HTML}{ACB7C4}
\definecolor{TitleColor}{HTML}{BBC6D2}
\definecolor{DrakeAccentColor}{HTML}{904AC2}
\definecolor{DrakeHighlightColor}{HTML}{B160EA}
\definecolor{BlockquoteBgColor}{RGB}{25,25,49}
\definecolor{CodeBlockBgColor}{HTML}{2B2B2B}
\definecolor{CodeBlockColor}{HTML}{A9B7C6}
\definecolor{TableBorderColor}{HTML}{1D1D26}
\definecolor{TableEvenColor}{HTML}{2C2C47}
...
\hypersetup{
	...
	pdfsubject={$subject$},
	$endif$
	pdfcreator={XeLaTeX via Pandoc drake-purple theme},
}
	%-------underline all links
\makeatletter
\Hy@AtBeginDocument{%
...
\renewenvironment{quote}{
	\begin{tcolorbox}[
		...
		outer arc=2\px,
		arc=2\px,
		colback=BlockquoteBgColor!53!BackgroundColor,
		coltext=TextColor,
		boxsep=0em,
		top=10\px,
		bottom=10\px,
